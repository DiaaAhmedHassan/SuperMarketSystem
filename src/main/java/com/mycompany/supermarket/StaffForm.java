    ...
    public StaffForm() {
        ...
        try {
            ...
            while((row = reader.readLine()) != null)
            {
                ...
                Staff member = new Staff(memberId, memberName, memberPhone, memberAge, staffAddress, memberSalary,userCard);
...
//                phoneNumber = this.memberPhone.getText();
    ...
    private void addButtonStaffActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonStaffActionPerformed
        ...
        Staff member = new Staff(memberId.getText(),memberName.getText(),memberPhone.getText(),Integer.parseInt(memberAge.getText()),address,Double.parseDouble(memberSalary.getText()),card);
    ...
    private void findButtonStaffActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_findButtonStaffActionPerformed
        ...
        for(Staff staff: staffMembers){
            /*Search by id*/
            if(memberId.getText().replaceAll(" ", "").equals(staff.getId().replaceAll(" ", ""))){
                isFound = true;
